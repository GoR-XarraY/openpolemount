...
| Your device (must fit the pocket envelope — see Specifications) | Your existing equipment |
...
Position the cradle on the IV pole at the height where you want the equipment.
...
Lower your device into the cradle from above. The device's pole hook/lug
seats into the cradle pocket. Verify the device is fully seated and does not rock
or tip.
...
- [ ] IV tubing can exit the device without creating strain on the mount
...
1. Disconnect the IV line from the device first (follow your care provider's instructions)
...
| Device rocks in the cradle | Wrong device size or print tolerance issue | Verify your device matches the pocket envelope; [open an issue](https://github.com/GoR-XarraY/openpolemount/issues) if it doesn't fit |
