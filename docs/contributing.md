...
OpenPoleMount is designed to grow. The cradle's mounting interface is
the **OpenPoleMount block** — a universal base for any IV pole accessory.
The 3D printing community can build the ecosystem.
...
This project is used by real patients. If your contribution affects load-bearing
parts or patient-contact surfaces:
...
we're friendly and want to help good ideas become real designs.
